...
<div class="w3-center" style="padding: 150px; padding-left: 0px; padding-right: 0px;">
  <figure class=" badges imghvr-fade w3-lemonmilk" style="background-color: transparent; border-radius: 10px; border-width: 10px;">
  ...
  <figure class=" badges imghvr-fade w3-lemonmilk" style="background-color: transparent; border-radius: 10px; border-width: 5px;">
  ...
  <h1 class="w3-lemonmilk w3-text-white w3-large">*global cooldown: 1 hour<br>
      **global cooldown: 2 hours
  </h1>
  <img src="https://www.paypalobjects.com/webstatic/en_US/i/buttons/buy-logo-large.png" alt="Buy now with PayPal" style="padding: 30px;"/>
</div>
