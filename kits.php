...
<div class="w3-container">
  <div class="w3-lemonmilk w3-center w3-text-white" style="padding: 100px; padding-left: 0px; padding-right: 0px;">
    ...
    <br>
    <br>
    <h2 class="underline w3-text-green3" style="margin-top: 100px; margin-bottom: 10px;">Basic ($1.00 each)</h2>
    <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px;"
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>Maplestrike</li><li>Military Mag x2</li><li>Military Crate x2</li><li>Gas Can</li><li>Blow Torch</li><li>MRE x2</li><li>Water x2</li><li>Dressing x5</li></ul>', 'Essentials Kit')">
    ...
    <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>MRE x10</li><li>Coconut Water x5</li><li>Energy Bar x5</li></ul>', 'Meals Kit')">
            <div class="w3-xlarge" style="color: #FF9D0F;">
    ...
    <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>Medkit x3</li><li>Bloodbag x2</li><li>Vaccine x3</li><li>Antibiotics x4</li><li>Dressing x5</li><li>Splint x2</li></ul>', 'First Aid Kit')">
            <div class="w3-xlarge" style="color: #FF9D0F;">
    ...
    <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>Locker x10</li></ul>', 'Storage Kit')">
            <div class="w3-xlarge" style="color: #FF9D0F;">
    ...
    <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>Rain Barrel x5</li><li>Water Tank</li><li>Canteen</li></ul>', 'Water Supply Kit')">
            <div class="w3-xlarge" style="color: #FF9D0F;">
    ...
    <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>Generator x2</li><li>Industrial Gas Can</li><li>Pump Jack x2</li><li>Fuel Tank</li></ul>', 'Energy Supply')">
            <div class="w3-xlarge" style="color: #FF9D0F;">
    ...
    <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>Snayperskya</li><li>Snayperskya Mag x3</li><li>8x Scope</li><li>Ranger Suppresor</li><li>Kryzkarek</li><li>Kryzkarek Mag</li><li>Low Caliber Ranger Ammunition x2</li><li>Headlamp</li><li>Binoculars</li></ul>', 'Defense Kit')">
            <div class="w3-xlarge" style="color: #FF9D0F;">
    ...
    <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>Bulldog</li><li>Bulldog Mag x3</li><li>Calling Card</li><li>Calling Card Mag</li><li>Halo Sight</li><li>Barrel</li><li>Low Caliber Ranger Ammunition x2</li><li>Butterfly Knife</li><li>Headlamp</li></ul>', 'Offense Kit')">
            <div class="w3-xlarge" style="color: #FF9D0F;">
    ...
    <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>Blowtorch</li><li>Metal Scrap x25</li><li>Cloth x10</li></ul>', 'Repair Kit')">
            <div class="w3-xlarge" style="color: #FF9D0F;">
    ...
    <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>Barbed Wire Fence x15</li><li>Barbed Wire x10</li></ul>', 'Fences Kit')">
            <div class="w3-xlarge" style="color: #FF9D0F;">
    ...
    <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>Pizza</li><li>Pumpkin Pie</li><li>Cake</li><li>BLT x2</li><li>Cheese Steak Sandwich x2</li><li>Cheese x2</li><li>Canned Soda x2</li><li>Canned Cola x2</li><li>Pancake x2</li><li>Waffle x2</li><li>Doughnut x2</li><li>Maple Syrup x2</li><li>Milk Box</li><li>Orange Juice Box</li><li>Grape Juice x2</li><li>Apple Juice x2</li><li>Chewing Gum</li><li>Cooler</li></ul>', 'Picnic Kit')">
            <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>Black Balaclava</li><li>Black T-Shirt</li><li>Cargo Pants</li><li>Paintball Gun</li><li>Purple Hopper x2</li><li>Blue Hopper x2</li><li>Green Hopper x2</li><li>Yellow Hopper x2</li><li>Orange Hopper x2</li><li>Red Hopper x2</li></ul>', 'Paintball Kit')">
            <div class="w3-xlarge" style="color: #FF9D0F;">
              <h1 class="underline w3-xlarge" style="color: #FF9D0F">Paintball</h1>
    ...
    <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px;"
      <figure class="imghvr-fade w3-lemonmilk">
        ...
        <figcaption style="background-color: #737a28">
          <button class="buttonkit" onclick="Alert.render('<ul><li>Horde Beacon</li><li>Chainsaw</li><li>Low Caliber Military Ammunition x4</li><li>Low Caliber Military Ammunition x2</li><li>SutureKit x2</li><ul><li>Horde Beacon</li><li>Chainsaw</li><li>Low Caliber Military Ammunition x4</li><li>Low Caliber Military Ammunition x2</li><li></li>Dressing x9</ul><ul><li>Horde Beacon</li><li>Chainsaw</li><li>Low Caliber Military Ammunition x4</li><li>Low Caliber Military Ammunition x2</li><li>Vaccine x3</li></ul></ul>', 'Horde Kit')">
            <div class="w3-xlarge" style="color: #FF9D0F;">
    ...
    <div>
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          <img class="kitsimages" src="http://i68.tinypic.com/2cqcgia.png">
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('<ul><li>Forest Military Helmet</li><li>Forest Military Shirt</li><li>Forest Military Vest</li><li>Forest Military Pants</li><li>Swissgewehr</li><li>Swissgewehr Mag x3</li><li>Backlash</li><li>12 Gauge Shells x6</li><li>Red Dot Sight</li><li>Vertical Grip</li><li>Adaptive Chambering</li><li>Low Caliber Military x2</li><li>Military Knife</li><li>Flashbang x2</li><li>MRE x2</li><li>Dressing x3</li><li></li></ul>', 'Forest Military Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          <img class="kitsimages" src="http://i65.tinypic.com/28kj48k.png">
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('<ul><li>Russian Military Helmet</li><li>Russian Military Top</li><li>Russian Military Vest</li><li>Russian Military Pants</li><li>Nykorev</li><li>Nykorev Box</li><li>Teklowvka</li><li>Teklowvka Magazine x3</li><li>Low Caliber Ranger Ammunition x4</li><li>Military Knife</li><li>Flashbang x2</li><li>MRE x2</li><li>Dressing x3</li></ul>', 'Russian Military Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          <img class="kitsimages" src="http://i68.tinypic.com/289zjm1.png">
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('<ul><li>Desert Military Helmet</li><li>Desert Military Top</li><li>Desert Military Vest</li><li>Desert Military Pants</li><li>Fusilaut</li><li>Military Drum</li><li>Desert Falcon</li><li>Desert Falcon Magazine x3</li><li>Low Caliber Military Ammunition x2</li><li>Military Knife</li><li>Flashbang x2</li><li>MRE x2</li><li>Dressing x3</li></ul>', 'Desert Military Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          <img class="kitsimages" src="http://i65.tinypic.com/202mg6.png">
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('<ul><li>Peaks Ghillie Hood</li><li>Peaks Ghillie Top</li><li>Peaks Ghillie Vest</li><li>Peaks Ghillie Bottom</li><li>Ghillie Netting x4</li><li>Ekho</li><li>Ekho Magazine x4</li><li>Maschingehewr</li><li>Maschingehewr Magazine x2</li><li>Low Caliber Ammunition x2</li><li>High Caliber Ammunition x2</li><li>Military Knife</li><li>Flashbang x2</li><li>MRE x2</li><li>Dressing x3</li></ul>', 'German Camo Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          <img class="kitsimages" src="http://i67.tinypic.com/11w50yp.png">
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('<ul><li>Russian Ghillie Hood</li><li>Russian Ghillie Top</li><li>Russian Ghillie Vest</li><li>Russian Ghillie Bottom</li><li>Ghillie Netting x4</li><li>Matamorez</li><li>Matamorez Box x3</li><li>Yuri</li><li>Yuri Magazine x2</li><li>Low Caliber Ranger Ammunition x2</li><li>High Caliber Ranger Ammunition</li><li>Military Knife</li><li>Flashbang x2</li><li>MRE x2</li><li>Dressing x3</li></ul>', 'Russian Camo Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          <img class="kitsimages" src="http://i63.tinypic.com/f0bwxi.png">
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('<ul><li>Snorkel</li><li>Wetsuit Top</li><li>Wetsuit Bottom</li><li>Diving Tank</li><li>Scalar</li><li>Scalar Magazine x3</li><li>Low Caliber Military Ammunition x3</li><li>Butterfly Knife</li><li>Oxygenator</li><li>MRE x2</li><li>Dressing x3</li></ul>', 'Scuba Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          <img class="kitsimages" src="http://i63.tinypic.com/2lu9bev.png">
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('<ul><li>Biohazard Hood</li><li>Biohazard Top</li><li>Biohazard Bottom</li><li>Empire</li><li>Empire Magazine x2</li><li>Military Knife</li><li>Low Caliber Military Ammunition x3</li><li>Filter x6</li><li>Vaccine x3</li><li>MRE x2</li><li>Dressing x3</li></ul>', 'Biohazard Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          <img class="kitsimages" src="http://i63.tinypic.com/2vx293p.png">
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('fuck it', 'Ranger Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          <img class="kitsimages" src="http://i64.tinypic.com/20nybc.png">
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('fuck it', 'Coastguard Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          <img class="kitsimages" src="http://i64.tinypic.com/2nsc9qq.png">
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('fuck it', 'Pilot Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
    ...
    <div>
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          ...
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('fuck it', 'Shield Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          ...
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('fuck it', 'Raid Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          ...
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('fuck it', 'Sentry Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          ...
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('fuck it', 'Light Sniper Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
        <figure class="imghvr-fade w3-lemonmilk">
          ...
          <figcaption style="background-color: #737a28">
            <button class="buttonkit" onclick="Alert.render('fuck it', 'Heavy Sniper Kit')">
              <div class="w3-xlarge" style="color: #FF9D0F;">
      ...
      <div>
        <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
          <figure class="imghvr-fade w3-lemonmilk">
            ...
            <figcaption style="background-color: #737a28">
              <button class="buttonkit" onclick="Alert.render('fuck it', 'Ammunition Kit')">
                <div class="w3-xlarge" style="color: #FF9D0F;">
        ...
        <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
          <figure class="imghvr-fade w3-lemonmilk">
            ...
            <figcaption style="background-color: #737a28">
              <button class="buttonkit" onclick="Alert.render('fuck it', 'OP Kit')">
                <div class="w3-xlarge" style="color: #FF9D0F;">
        ...
        <div style="margin-top: 100px; margin-left: 20px; margin-right: 20px; border-radius: 10px"
          <figure class="imghvr-fade w3-lemonmilk">
            ...
            <figcaption style="background-color: #737a28">
              <button class="buttonkit" onclick="Alert.render('fuck it', 'Lancer Kit')">
                <div class="w3-xlarge" style="color: #FF9D0F;">
